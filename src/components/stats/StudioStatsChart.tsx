...
export function StudioStatsChart() {
  ...
  const chartData = useMemo(() => {
    ...
    shelf.forEach(anime => {
      if (anime.user_status === 'completed') { // Consider only completed anime
    ...
    return Object.entries(studioCounts)
      ...
      .slice(0, 15); // Take top 15 studios for readability
  ...
  return (
    <Card>
      ...
      <CardContent className="h-[400px] pb-0"> {/* Increased height */}
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={chartData} layout="vertical" margin={{ left: 20, right: 20, bottom: 20 }}> {/* Added margin */}
            ...
            <YAxis 
                ...
                axisLine={false} 
                tickMargin={5} 
                width={120} // Adjust width for studio names
